 ...
 * Copyright ${symbol_dollar}{year}, Red Hat, Inc., and individual contributors
 ...
 */
package ${groupId}.html5_mobile.util;
...
public class JSONPRequestFilter implements Filter {
    ...
    public static final Pattern SAFE_PRN = Pattern.compile("[a-zA-Z0-9_${symbol_escape}${symbol_escape}.]+");
