...
The client application will be running at the following URL <http://localhost:8080/${artifactId}-web/>
while the JAX-RS services will be running at <http://localhost:8080/${artifactId}-services/rest>.
